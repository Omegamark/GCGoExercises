...
func TestCat(t *testing.T) {
	...
	xs := strings.Split(s, " ")
	s = Cat(xs)
	// *** Mark testing why the test was failing. Fix in the function, not the test.
	// fmt.Println("I'm the variable:", len(s))
	// fmt.Println("I'm the typed string:", len("Shaken not stirred"))
	// s = strings.Trim(s, " ")
